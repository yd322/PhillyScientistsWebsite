           ...
           <!-- /. NAV TOP  -->
            ...
            <div class="sidebar-collapse">
				...
				<li class="text-center">
                    ...
                    <li>
                        <a class="active-menu"  href="home.php"><i class="fa fa-home fa-3x"></i> Home</a>
...
elseif(!empty($_POST['username']) && !empty($_POST['password']))
{
    ...
    {
        echo "<h2>Error</h2>";
        echo "<h5>Sorry, incorrect login details. Please <a href=\"home.php\">click here to try again</a>.</h5>";
    }
}
else
{
   ...
   <h5>Please enter your details below to Login. <a href="register.php">Click Here to Register</a>.</h5>
    ...
    <form role="form" method="post" action="home.php" name="loginform" id="loginform">
    <fieldset>
